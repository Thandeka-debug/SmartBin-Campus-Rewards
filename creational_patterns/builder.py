...
class Reward:
    ...
    def __str__(self) -> str:
        return f"Reward(id={self.reward_id}, name={self.name}, cost={self.point_cost}, inventory={self.inventory_count})"
...
if __name__ == "__main__":
    ...
    print("Built reward:", reward)
    
    coffee = RewardDirector.create_coffee_voucher()
    print("Coffee Voucher:", coffee)
